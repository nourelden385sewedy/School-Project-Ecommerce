...
namespace School_ECommerce.Migrations
{
    ...
    [Migration("20251002192518_EditOnDataSeeding")]
    partial class EditOnDataSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("School_ECommerce.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            DeliveryTime = new DateTime(2025, 10, 5, 19, 25, 18, 379, DateTimeKind.Utc).AddTicks(2241),
                        ...
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            DeliveryTime = new DateTime(2025, 10, 4, 19, 25, 18, 379, DateTimeKind.Utc).AddTicks(2248),
                        ...
                        new
                        {
                            Id = 3,
                            CustomerId = 3,
                            DeliveryTime = new DateTime(2025, 10, 4, 19, 25, 18, 379, DateTimeKind.Utc).AddTicks(2260),
                        ...
                        new
                        {
                            Id = 4,
                            CustomerId = 1,
                            DeliveryTime = new DateTime(2025, 10, 7, 19, 25, 18, 379, DateTimeKind.Utc).AddTicks(2264),
                        ...
                        new
                        {
                            Id = 5,
                            CustomerId = 4,
                            DeliveryTime = new DateTime(2025, 10, 8, 19, 25, 18, 379, DateTimeKind.Utc).AddTicks(2267),
                            OrderId = new Guid("44444444-4444-4444-4444-444444444444"),
                            TotalPrice = 139.98m
                        });
                });
